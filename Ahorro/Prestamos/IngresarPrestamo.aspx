<%@ Page Title="" Language="C#" MasterPageFile="~/Prestamos/MPPrestamos.master" AutoEventWireup="true" CodeBehind="IngresarPrestamo.aspx.cs" Inherits="Ahorro.Prestamos.IngresarPrestamo" EnableEventValidation="false" ValidateRequest="false" %>
            ...
            <div>
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" ID="txt_idempleado" name="txt_idempleado" runat="server" placeholder="##" required/>
